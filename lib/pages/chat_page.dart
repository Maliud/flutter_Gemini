                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          suggestContainer('Satışı Teşvik Emek İçin Bir E-posta Yaz',Colors.purpleAccent),
                                          suggestContainer('J.K Rowling Tarzı Kısa Bir Öykü Yaz.',Colors.orangeAccent),
                                          suggestContainer('Noel Mesajı Yazar mısın?',Colors.greenAccent),
                                          suggestContainer('Yazılım Mülakat Sorusu Örneği Verir misin?',Colors.blueAccent)
                                        ],
                                      ),
                                    ),
                                  ],
